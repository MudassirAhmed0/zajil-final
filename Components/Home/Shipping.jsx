  ...
  return (
    <section ref={content} className=" flex flex-col items-center md:pt-16 pt-14">
          <span className="box">
            ...
            <div className="w-4/5 flex justify-between text-grey mt-12  gap-y-8 flex-wrap ">
                ...
                <Link href="#" >
                 <a className="md:w-1/3 w-5/12 flex md:border-none border-t border-borderGrey hover:scale-110 mx-auto md:mx-0 transition-all duration-300	 parent items-center justify-center flex-col pt-6 pb-2 gap-y-3" >
