...
const Logistics = () => {
    ...
    return (
        <YellowBack>
            ...
            <div className={`flex gap-y-9 text-white relative overflow-hidden hidden md:flex flex-col bg-yellow ${styles.accordion}`}>
                ...
                {showImage3 && <span className='fade absolute top-0 img_container w-full h-full'>
                    <Image src={accordionImage3} alt={accordionImage} />
                </span>}
                {showImage4 && <span className='fade absolute top-0 img_container w-full h-full'>
                    <Image src={accordionImage4} alt={accordionImage} />
                </span>}
            ...
            <div className='flex md:hidden  mt-7 flex-col gap-y-[22px]'>
                ...
                <span className={overlays.accordionOverlay}>
                    ...
                    <span className='fade absolute top-0 img_container w-full h-full'>
                        <Image src={accordionImage2} alt={accordionImage2} />
                    </span>
                    <div className={` flex justify-center pl-5 pr-6 flex-col gap-y-2  `}>
                ...
                <span className={overlays.accordionOverlay}>
                    ...
                    <span className='fade absolute top-0 img_container w-full h-full'>
                        <Image src={accordionImage3} alt={accordionImage3} />
                    </span>
                    <div className={` flex justify-center pl-5 pr-6 flex-col gap-y-2  `}>
                ...
                <span className={overlays.accordionOverlay}>
                    ...
                    <span className='fade absolute top-0 img_container w-full h-full'>
                        <Image src={accordionImage4} alt={accordionImage4} />
                    </span>
                    <div className={` flex justify-center pl-5 pr-6 flex-col gap-y-2  `}>
