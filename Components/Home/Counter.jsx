  ...
  return ( 
    <section className={`  relative  ${styles.videoSection}  mt-24`}>
      ...
      <span className="absolute top-0 left-0 w-full h-full overflow-hidden">
        ...
        return(
        <div className={`flex justify-between text-white flex-wrap relative gap-y-16 ${styles.counter}` }>
          <div className={`flex flex-col  md:w-1/3 lg:w-auto sm:w-1/2 ${styles.counterItem}`}>
         ...
         {startCounter &&   <CountUp duration={3} end={396}/>}
          ...
          <div className={`flex flex-col md:w-1/3 md:ml-auto lg:w-auto  lg:ml-0 sm:w-1/2 ${styles.counterItem}`}>
            <span className="md:text-5xl text-4xl  bold-font">
        {startCounter &&    <CountUp duration={3} end={1055}/>}
          ...
          <div className={`flex flex-col md:w-1/3 lg:w-auto  md:mr-auto lg:mr-0 sm:w-full  ${styles.counterItem}`}>
            <span className="md:text-5xl text-4xl  bold-font">
              117
            </span>
            <span className="text-offWhite text-center md:mt-0 -mt-2">
