    ...
    return (
        <>
            <div className={`${styles.BlueSection}`}>
                <div className=' '>
                    <div className={`flex xl:flex-nowrap relative lg:flex-nowrap flex-wrap-reverse justify-between xl:px-20 xl:pt-24 pt-[57px] px-[18px]`}>
                ...
                <div className={`h-auto ${styles.bottomContent}`}>
                    <div className='xl:px-20 xl:py-16 px-[18px] py-[54px] '>
                        {content.map(item =>
                            <div key={item?.id} style={visibleTab === item.id ? {} : { display: 'none' }} className='flex xl:flex-nowrap lg:flex-nowrap flex-wrap justify-between'>
