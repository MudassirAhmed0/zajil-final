...
const RightImage = () => {
  ...
  return (
    <div className="  flex-col-reverse flex  gap-y-8  lg:flex-row md:pl-20 md:pr-20 pl-5 pr-5 pt-14 lg:pt-28 pb-24 relative items-center justify-between gap-x-14">
