  ...
  return (
    <Modal py='md:pt-11 md:pb-20 py-10' modalId='paymentSuccessful'>
            ...
            <div className='flex gap-x-1.5 mt-12'>
                ...
                <Image onClick={()=> setStars(1)} className='cursor-pointer' src={stars >= 1 ? yellowStar :whiteStar}/>
                <Image onClick={()=> setStars(2)} className='cursor-pointer' src={stars >= 2 ? yellowStar :whiteStar}/>
                <Image onClick={()=> setStars(3)} className='cursor-pointer' src={stars >= 3 ? yellowStar :whiteStar}/>
                <Image onClick={()=> setStars(4)} className='cursor-pointer' src={stars >= 4 ? yellowStar :whiteStar}/>
                <Image onClick={()=> setStars(5)} className='cursor-pointer' src={stars >= 5 ? yellowStar :whiteStar}/>
