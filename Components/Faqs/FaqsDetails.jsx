...
import bottomFrame from '../../assets/NewImages/faqs/faqFrame.svg'
import Select from 'react-select';

const options = [
    { value: 'leftParaOne', label: 'Where can I drop off my package for pick-up?' },
    { value: 'leftParaTwo', label: 'What is your pricing?' },
    { value: 'leftParaThree', label: 'What does a Zajil tracking number look like?' },
    { value: 'leftParaFour', label: 'How do I create a COD shipment?' },
    { value: 'leftParaFive', label: 'What’s the difference between Door-to-door service (D2D) and Last-mile Delivery (LMD) service?' }, 
    { value: 'RightParaOne', label: 'I’m a normal person. Do I need to create an account before I can ship with Zajil?' },
    { value: 'RightParaTwo', label: 'How do I start a return?' },
    { value: 'RightParaThree', label: 'How can I contact a person to help me?' },
    { value: 'RightParaFour', label: 'How can I file a claim?' },
    { value: 'RightParaFive', label: 'Do you ship to all countries?' },
    { value: 'RightParaSix', label: 'What are the requirements for shipping, such as size, shape, or weight of my package?' }, 
];
...
const FaqsDetails = ({ setPopupData, openModal }) => {
    ...
    const handleChange = (newValue) => {
        let answer = data[0][newValue.value]
    ...
    return (
        <div className={`relative overflow-hidden ${styles.hFaqs}`} >
            <span className={`absolute ${styles.brandIconFaq}`}>
                <Image src={bottomFrame} alt="top frame" />
            </span>
            <div className={styles.topSection} >
                <div className='flex justify-center pt-8 px-[18px]'>
