...
import brandIcon from '../../../assets/images2/svg/theAppBrand.svg' 

const AppDetail = () => {
  return (
    <div className='lg:py-16 overflow-hidden relative lg:pr-32 lg:pl-16 px-[18px] pt-[46px] pb-[51px]'>
        ...
        <div className='mt-10 flex lg:flex-nowrap md:flex-wrap flex-wrap justify-between items-center'>
            ...
            <div className={styles.textw}>
                ...
                <div className='flex gap-x-5 pt-6'>
                    <span className='img_container h-10 w-28 rounded-mmd relative overflow-hidden'>
