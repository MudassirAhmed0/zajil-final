...
const ShareArticle = () => {
    ...
    <Modal py='pt-11 pb-20' modalId='shareArticle'>
            ...
            <div className="w-7/12 flex justify-between mt-12 mb-12 text-grey"> 
             <a href="https://www.linkedin.com/shareArticle?mini=true&url=url" className="w-3-12 flex hover:scale-110 transition-all duration-300 flex-col gap-y-4" target='_blank' >
                <Image width={40} height={40} src={linkedin}/>
                <span className=''>  Share On Linkedin</span>
             </a> 
             <a href="https://twitter.com/share?text=text&url=url" target='_blank' className="w-3-12 flex hover:scale-110 transition-all duration-300 flex-col gap-y-4">
                <Image width={40} height={40} src={twitter}/>
                <span className=''>  Share On Twitter</span>
             </a>
             <a href="https://www.facebook.com/sharer.php?u=url" target='_blank' className="w-3-12 flex hover:scale-110 transition-all duration-300 flex-col gap-y-4">
                <Image width={40} height={40} src={facebook}/>
                <span className=''>  Share On Facebook</span>
             </a>
             <a href="mailto:?&subject=&cc=&bcc=&body=url" target='_blank'className="w-3-12 flex hover:scale-110 transition-all duration-300 flex-col gap-y-4">
                <Image width={40} height={40} src={email}/>
