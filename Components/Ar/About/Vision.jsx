...
const Vision = () => {
  ...
  return (
    <section className=' relative  bg-blue ' >
      ...
      <div className={`max-1394 pt-32 md:p-0 px-8 pb-12 flex md:flex-row flex-col   ml-auto mr-auto  justify-center ${styles.visionBorder}`}>
        ...
        <div ref={mission} className='flex  flex-col items-center md:items-start md:pt-12 md:w-2/6 w-full md:mr-10 mr:0 '>
          <Image src={box} alt='box' />
          <span className="text-yellow medium-font md:text-3xl text-xl mt-2 mb-2">
            Mission
          </span>
